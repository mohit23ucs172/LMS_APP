...
{...prev,
  ...
  return courseData? (
    ...
    <div className='absolute top-0 left-0 w-full h-[500px] -z-10 bg-gradient-to-b from-cyan-400/40 to-transparent'></div>
     {/* left column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-5xl text-3xl font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <p className='text-sm'>Course by <span className='text-blue-600 underline'>Mohit Tiwari</span></p>
